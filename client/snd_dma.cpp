...
//	S_UpdateBackgroundTrack();
	...
	if (s_rawend > s_paintedtime)
	{
		...
		{
			OutputDebugStringA("UpdateRawSamples :- Raw Sample buffer has overflowed !!!\n");
...
#ifdef _DEBUG
			OutputDebugStringA("Restarting / Starting playback of Raw Samples\n");
#endif
...
#ifdef _DEBUG
	if (alGetError() != AL_NO_ERROR)
		OutputDebugStringA("OAL Error : UpdateRawSamples\n");
#endif
}
